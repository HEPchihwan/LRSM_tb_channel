...
# 출력할 submit 스크립트 폴더
OUT_DIR="/data6/Users/achihwan/LRSM_tb_channel/SAMPLEPRODUCTION/using_matrix/condor/1AK4_1AK8/result/btag_PN_tight_hlt_30/WR_cut_2000/top_0.9_120_250/mll300mu1pt50eta2.4/bkg/condorfile"
mkdir -p "${OUT_DIR}"
